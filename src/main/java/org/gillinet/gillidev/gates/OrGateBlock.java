...
public class OrGateBlock extends BaseGateBlock {
    public static final MapCodec<OrGateBlock> CODEC = Block.simpleCodec(OrGateBlock::new);
    public OrGateBlock(Properties props) { super(props); }
